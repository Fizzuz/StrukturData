        ...
        do {
            ...
            switch (pilih){
                ...
                case 2:
                    ...
                    if(dinilai != null) {
                        System.out.println("Menilau tugas dari " + dinilai.nama);
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Mahasiswa16 lihatBawah = stack.peekBottom();
                    if (lihatBawah != null) {
                        System.out.println("Tugas pertama dikumpulkan oleh " + lihatBawah.nama);
                    }
                    break;
                case 6: 
                    System.out.println("Jumlah tugas yang dikumpulkan: " + stack.hitungJumlahTugas());
                    break;
                default:
